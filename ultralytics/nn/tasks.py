...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
                 ...
                 C3_AKConv, C2f_AKConv, AKConv, C3_MLCA, C2f_MLCA, SPPCSPC, SPPFCSPC, SPPCSPC_group, SPPFCSPC_group, SE_ASPP, CBAM_ASPP,
                 SPPF_group, SPPF_MB, SPPF_Attention,SPPF_MLCA, SPPF_MPCA, SPPF_MBCA, SPPF_MCDA, 
                 ):
            if args[0] == 'head_channel':
                args[0] = d[args[0]]
            c1, c2 = ch[f], args[0]
            ...
            c2 = m.channel
                   ...
                   EffectiveSEModule, LSKA, SegNext_Attention, DAttention, MLCA, MCDA, }:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
